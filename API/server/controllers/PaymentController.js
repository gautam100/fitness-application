            ...
            connection.query(sql_query, function (err, rows) {
                ...
                connection.query(sql_query_template, function (err, rows_template) {
                    ...
                    if (rows_template.length > 0) {
                        ...
                        const redirectUrl = "http://52.14.36.239:4200/payment/payment-confirmation-page/" + paymentSuccessBody.udf1;
            ...
            connection.query(sql_query, function (err, rows) {
                ...
                connection.query(sql_query_template, function (err, rows_template) {
                    ...
                    if (rows_template.length > 0) {
                        ...
                        const redirectUrl = "http://52.14.36.239:4200/payment/payment-failure-page/" + paymentFailureBody.udf1;
                        res.redirect(redirectUrl);
                    }
                });
            });
